...
namespace Hooks
{
	...
	// CloudSync hooks for WebDAV cloud save replacement
	typedef bool(*IClientRemoteStorage_FileWrite_t)(void*, uint32_t, const char*, const void*, int32_t);
	typedef int32_t(*IClientRemoteStorage_FileRead_t)(void*, uint32_t, const char*, void*, int32_t);
	typedef bool(*IClientRemoteStorage_FileDelete_t)(void*, uint32_t, const char*);
	typedef bool(*IClientRemoteStorage_FileExists_t)(void*, uint32_t, const char*);
	typedef int32_t(*IClientRemoteStorage_GetFileSize_t)(void*, uint32_t, const char*);
	typedef int64_t(*IClientRemoteStorage_GetFileTimestamp_t)(void*, uint32_t, const char*);
	typedef int32_t(*IClientRemoteStorage_GetFileCount_t)(void*, uint32_t);
	typedef const char*(*IClientRemoteStorage_GetFileNameAndSize_t)(void*, uint32_t, int, int32_t*);
	...
	// CloudSync hooks
	extern VFTHook<IClientRemoteStorage_FileWrite_t> IClientRemoteStorage_FileWrite;
	extern VFTHook<IClientRemoteStorage_FileRead_t> IClientRemoteStorage_FileRead;
	extern VFTHook<IClientRemoteStorage_FileDelete_t> IClientRemoteStorage_FileDelete;
	extern VFTHook<IClientRemoteStorage_FileExists_t> IClientRemoteStorage_FileExists;
	extern VFTHook<IClientRemoteStorage_GetFileSize_t> IClientRemoteStorage_GetFileSize;
	extern VFTHook<IClientRemoteStorage_GetFileTimestamp_t> IClientRemoteStorage_GetFileTimestamp;
	extern VFTHook<IClientRemoteStorage_GetFileCount_t> IClientRemoteStorage_GetFileCount;
	extern VFTHook<IClientRemoteStorage_GetFileNameAndSize_t> IClientRemoteStorage_GetFileNameAndSize;
