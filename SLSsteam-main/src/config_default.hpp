...
#CloudSync: Replace Steam Cloud with your own WebDAV server
#This allows you to sync game saves to your own server (Nextcloud, etc.)
#Files are stored locally in ~/.local/share/SLSsteam/cloudsync/<appid>/
#and synced to WebDAV asynchronously
CloudSync:
  Enabled: no
  WebDAVUrl: ""      # e.g., "https://nextcloud.example.com/remote.php/dav/files/user/"
  Username: ""
  Password: ""
