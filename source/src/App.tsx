      ...
      try {
        ...
        if (savedToolSettings) {
          setSettings({
            ...
            steamUsername: savedToolSettings.steamUsername || "",
            steamPassword: savedToolSettings.steamPassword || "",
            achievementMethod: (savedToolSettings.achievementMethod as "web_api" | "steam_cm") || "web_api",
          });
        }
