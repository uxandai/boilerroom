...
import { LibraryGameItem } from "./LibraryGameItem";
...
export function LibraryPanel() {
  ...
  // Handlers for Game Item Actions
  ...
  const handleCopyGame = useCallback((game: InstalledGame) => {
    setCopyToRemoteGame(game);
  }, []);

  const handleUninstallGame = useCallback(async (game: InstalledGame) => {
