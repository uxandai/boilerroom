...
export function LibraryPanel() {
  ...
  // Optimized Handlers
  const handleSearch = useCallback((appIdOrName: string) => {
    setSearchQuery(appIdOrName);
    setActiveTab("search");
  ...
  }, [addLog, connectionMode, refreshGames, sshConfig]);
  ...
  // Memoized sorted and filtered games list to avoid re-calculation on every render
