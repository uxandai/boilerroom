...
import { checkMorrenusApiStatus, type MorrenusUserStats } from "@/lib/api";
...
export function ApiStatus() {
  ...
  const [stats, setStats] = useState<MorrenusUserStats | null>(null);
  ...
  const checkApiStatus = useCallback(async () => {
    ...
    try {
      const result = await checkMorrenusApiStatus(settings.apiKey || "");
